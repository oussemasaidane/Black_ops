<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <br><br>
        <a class="mt-5 underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="/login">
           Annuler </a>
    </form>
</x-guest-layout>
