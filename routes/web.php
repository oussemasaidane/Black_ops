...
Route::post('/categories', [App\Http\Controllers\CategorieController::class, 'store'])->name('categories.store')->middleware('verify_souscategorie');
...
Route::put('/categories/{categorie}', [App\Http\Controllers\CategorieController::class, 'update'])->name('categories.update')->middleware('verify_souscategorie');;

Route::resource('sous_categories', App\Http\Controllers\SousCategorieController::class);

//Route::post('sous_categories',[ App\Http\Controllers\SousCategorieController::class,'store'])->middleware('verify_souscategorie');
